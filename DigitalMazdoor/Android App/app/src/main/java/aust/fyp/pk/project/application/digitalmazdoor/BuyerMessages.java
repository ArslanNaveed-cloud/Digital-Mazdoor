...
public class BuyerMessages extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_buyer_messages, container, false);
    ...
    public void GetFreelancer(){
        ...
        String url = Urls.GETFREELANCERS;
        Log.i("112233",url);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("500")){
                                ...
                                message.setText("You Do not Have Any Message");
                                ...
                                for(int i=0;i<buyerid.length();i++){
                                    ...
                                    if(identifierid.contains(bid)){
                                        ...
                                        msgsize = msgsize-1;
                                        String text = message.getString(msgsize);
