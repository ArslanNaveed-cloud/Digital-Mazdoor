...
public class SentOffers extends Fragment {
    View view;
    RecyclerView recyclerView;
    LinearLayout loader,mylayout;
    TextView message;
    SentOffersAdaphter adaphter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.sentofferslist);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("500")){
                                ...
                                message.setText("You Didnot send any Offers");
                                ...
                                adaphter = new SentOffersAdaphter(newRequestDataModels,getActivity(),0);
