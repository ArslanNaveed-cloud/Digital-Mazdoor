...
public class OrdersRequest extends Fragment {
    ...
    public void VolleyRequest(){
        ...
        String url = Urls.GET_ORDERREQUEST;
        Log.i("112233",url);
                        ...
                        try {
                            ...
                            if(status.equals("500")){
                                ...
                                for (int i = 0; i < ordderid.length(); i++) {
                                    ...
                                    String title = bname+" has Requested On Gig Titled '"+gname+" on "+pdate;
                                ...
                                adaphter = new OrderRequestAdaphter(newRequestDataModel,getActivity(),ordersRequest);
