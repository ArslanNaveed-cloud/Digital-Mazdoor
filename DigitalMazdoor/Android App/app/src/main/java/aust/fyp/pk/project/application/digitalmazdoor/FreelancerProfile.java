...
public class FreelancerProfile extends Fragment {


    View view;
    TextInputEditText name,email,profiledescription,phone,password;
    TextView main_cat,sub_cat;
    String NAME="",EMAIL="",PHONE="",PASSWORD="",PROFILESUMMARY="",FILEPATH="",PROFILEPICTURE="";
    String NAME1="",EMAIL1="",PHONE1="",PASSWORD1="",PROFILESUMMARY1="",MAINCAT1="",SUBCAT1="",PROFILEPICTURE1="",ID="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PROFILESUMMARY = sharedPreferences.getString("summary","");
        ...
        Glide.with(getActivity()).load(url1).circleCrop().
                into(profilepic);
        profiledescription.setText(PROFILESUMMARY);
        phone.setText(PHONE);
    ...
    private void checkcontents() {
        ...
        PROFILESUMMARY1 = profiledescription.getText().toString().trim();
        ...
        if(PROFILESUMMARY1.equals("") || PROFILESUMMARY1.isEmpty()){
            profiledescription.setError("Field Cannot be Empty");
            isError = true;
        }else if(PROFILESUMMARY1.length() >500){
            profiledescription.setError("Only 500 characters are allowed");
            isError = true;
        }else{
            isError= false;
        }
        ...
        if(!isError){
            if(NAME1.equals(NAME) && EMAIL1.equals(EMAIL) &&
                    ...
                    PHONE1.equals(PHONE) && PROFILESUMMARY1.equals(PROFILESUMMARY) && FILEPATH.isEmpty()){
    ...
    private void UpdatewithoutProfilePicture() {
            ...
            String url = Urls.UPDATEWITHOUTPROFILEPICTURE;
            Log.i("112233",url);
    ...
    private void UpdatewithProfilePicture() {
            ...
            Ion.with(getActivity())
                    .load("POST", Urls.UPDATEWITHPROFILEPICTURE)
                    ...
                    .setMultipartParameter("profilesummary", PROFILESUMMARY1)
