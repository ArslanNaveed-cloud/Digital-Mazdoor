...
public class MyOrders extends Fragment {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("500")){
                                ...
                                adaphter = new OrderAdaphter(newRequestDataModels,getActivity(),MyOrders.this,"freelancer");
    ...
    public void setrating(String buyerid) {
        ...
        bundle.putString("bid", buyerid );
        bundle.putString("identifier", "buyerrating" );
