...
public class BuyerLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BuyerLogin.this,BuyerForgotPassword.class);
        ...
        signupuser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BuyerLogin.this,BuyerSignupScreen.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void VolleyRequest(){
        ...
        RequestQueue queue = Volley.newRequestQueue(BuyerLogin.this);

        String url = Urls.LOGIN_BUYER;
        Log.i("112233",url);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("500")){
                                ...
                                buildDialog(BuyerLogin.this,"502","Internal Server Error").show();
                            }
                            else if(status.equals("404")){
                                loader.setVisibility(View.GONE);

                                buildDialog(BuyerLogin.this,"Access Deined","Email/password is wrong").show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                loader.setVisibility(View.VISIBLE);
                buildDialog(BuyerLogin.this,"Error","Please Try Again Later").show();
            }
        }) {
    ...
    public void waitforsometime(){
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                Intent intent = new Intent(BuyerLogin.this,BuyerLogin.class);
                startActivity(intent);
                finish();
            }
        }, 2000);
